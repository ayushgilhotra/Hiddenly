...
/**
 * LEARNING NOTE:
 * The Login page uses a minimal, centered card layout.
 * We handle form state using "useState" and submission with the "login" function from AuthContext.
 */
const Login = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError('Invalid credentials. The path is narrow, try again.');
        } finally {
            setLoading(false);
        }
    };
        ...
        <div className="min-h-screen flex items-center justify-center p-4">
            ...
            >
                <div className="text-center mb-8">
                    ...
                    <p className="text-white/40 text-sm italic">"Not all who wander are lost, but some need to login."</p>
                </div>
                ...
                <p className="mt-8 text-center text-sm text-white/40">
                    New explorer? <Link to="/register" className="text-accent hover:underline">Register your journey</Link>
                </p>
            </motion.div>
        </div>
    );
